...
This function takes two byte pointers(src & dst) and a length of bytes to move from 
the source location to the destination. 
@param:pointer to source memory, pointer to destination memory, length of data in
bytes
...
This function takes two byte pointers(src & dst) and a length of bytes to copy from 
the source location to the destination. 
@param:pointer to source memory, pointer to destination memory, length of data in
bytes
@return:pointer to destination memory.
...
This function deallocates dynamic memory by providing pointer source to the function
